...
const PlaceDetails = () => {
    ...
    const [deleteReviewModal, setDeleteReviewModal] = useState(null); // stores reviewId
    ...
    const handleReviewSubmitted = (newReview) => {
        // The server returns the review with `user` as an unpopulated ObjectId.
        // Inject the current user's info so the name/avatar shows instantly.
    ...
    const confirmDeleteReview = async () => {
        try {
            await api.delete(`/reviews/${deleteReviewModal}`);
            setReviews(reviews.filter(r => r._id !== deleteReviewModal));
    ...
    return (
        <>
            ...
            <ConfirmModal
                ...
                message="This will permanently remove the place and all associated media. This action cannot be undone."
            ...
            <ConfirmModal
                ...
                message="Once deleted, this review cannot be recovered."
